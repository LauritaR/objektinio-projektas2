     ...
     else if(ats=="p")
    {
     ...
     start = std::chrono::high_resolution_clock::now();
       ...
       difference = end - start;
        cout << "Rusiavimas:  " << difference.count() << " s\n";
}
...
void skirstymas(string filename)
{
    ...
    list<studentukas> stud;
    skaitymas(filename,stud);
     
    list<studentukas> vargseliai;
    list<studentukas> saunuoliai;
   auto start = std::chrono::high_resolution_clock::now();
   for(auto& laik:stud)
    {
...
start = std::chrono::high_resolution_clock::now();
   ...
   difference = end - start;
    cout << "Studentu irasymas uztruko: " << difference.count() << " s\n"; 
}
